...
- Example: <InlineCode lang="ini" code={`name="PICO"`}/> shows "PICO" as the week title
- Can be anything you want: <InlineCode lang="ini" code={`name="MY COOL WEEK"`}/>
...
- Format: <code class="token string">"opponent,boyfriend,girlfriend"</code> (no spaces!)
- Location: `./images/menus/storymenu/characters/`
- Example: <InlineCode lang="ini" code={`chars="pico,bf,gf"`}/>
...
- Example: <InlineCode lang="ini" code={`sprite="week3"`}/> looks for `week3.png` in that folder
