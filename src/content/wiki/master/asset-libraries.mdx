...
For example, if you want to path to a file like `./images/stages/stage.png`, you would do <InlineCode lang="haxe" code={`Library.getPath('assets/images/stages/stage.png')`}/>. This would return the file's location based on the context of where your library wants to locate for your files.
...
<div style="display: flex; justify-content: center; gap: 15px;">
    <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/library/Example Script 1.png"} alt="Freeplay."         title="Freeplay."         style="width:50%;"/>
    <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/library/Example Script 2.png"} alt="Yes, this is UGH." title="Yes, this is UGH." style="width:50%;"/>
</div>
</details>
